...
func (s SMStartFunc) GetName() string {
	return "test-sm"
}

func (s SMStartFunc) Start(gs GSInterface) error {
	return s()
}

func (s SMStartFunc) ShutdownStart() error {
	return nil
}

func (s SMStartFunc) ShutdownFinish() error {
	return nil
}

type SMShutdownStartFunc func() error

func (s SMShutdownStartFunc) GetName() string {
	return "test-sm"
}

func (s SMShutdownStartFunc) Start(gs GSInterface) error {
	return nil
}

func (s SMShutdownStartFunc) ShutdownStart() error {
	return s()
}

func (s SMShutdownStartFunc) ShutdownFinish() error {
	return nil
}

type SMShutdownFinishFunc func() error

func (f SMShutdownFinishFunc) GetName() string {
	return "test-sm"
}

func (f SMShutdownFinishFunc) Start(gs GSInterface) error {
	return nil
}

func (f SMShutdownFinishFunc) ShutdownStart() error {
	return nil
}

func (f SMShutdownFinishFunc) ShutdownFinish() error {
	return f()
}
...
func TestStartGetCalled(t *testing.T) {
	...
	if len(c) != 15 {
		t.Errorf("ttt %d", len(c))
	}
}

func TestStartErrorGetReturned(t *testing.T) {
	gs := New()
	...
	err := gs.Start()
	if err == nil || err.Error() != "text-error" {
...
func TestErrorHandlerFromFinishShutdown(t *testing.T) {
	...
	gs.StartShutdown(SMShutdownFinishFunc(func() error {
		return errors.New("my-error")
	}))
