...
# 设置统一的密码，方便记忆
readonly PASSWORD=${PASSWORD:-'amcon123'}

# Linux系统 going 用户
readonly LINUX_USERNAME=${LINUX_USERNAME:-gopc}
...
# iam 配置
readonly IAM_DATA_DIR=${IAM_DATA_DIR:-/data/myiam} # iam 各组件数据目录
readonly IAM_INSTALL_DIR=${IAM_INSTALL_DIR:-/opt/myiam} # iam 安装文件存放>目录
readonly IAM_CONFIG_DIR=${IAM_CONFIG_DIR:-/etc/myiam} # iam 配置文件存放目>录
readonly IAM_LOG_DIR=${IAM_LOG_DIR:-/var/log/myiam} # iam 日志文件存放目录
...
readonly IAM_APISERVER_INSECURE_BIND_PORT=${IAM_APISERVER_INSECURE_BIND_PORT:-18080}
readonly IAM_APISERVER_SECURE_BIND_ADDRESS=${IAM_APISERVER_SECURE_BIND_ADDRESS:-0.0.0.0}
readonly IAM_APISERVER_SECURE_BIND_PORT=${IAM_APISERVER_SECURE_BIND_PORT:-18443}
...
readonly IAM_AUTHZ_SERVER_INSECURE_BIND_PORT=${IAM_AUTHZ_SERVER_INSECURE_BIND_PORT:-19090}
readonly IAM_AUTHZ_SERVER_SECURE_BIND_ADDRESS=${IAM_AUTHZ_SERVER_SECURE_BIND_ADDRESS:-0.0.0.0}
readonly IAM_AUTHZ_SERVER_SECURE_BIND_PORT=${IAM_AUTHZ_SERVER_SECURE_BIND_PORT:-19443}
