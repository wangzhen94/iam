...
import (
	...
	"github.com/wangzhen94/iam/internal/iamctl/cmd/color"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/completion"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/info"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/jwt"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/new"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/options"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/policy"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/secret"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/set"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/user"
	cmdutil "github.com/wangzhen94/iam/internal/iamctl/cmd/util"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/validate"
	"github.com/wangzhen94/iam/internal/iamctl/cmd/version"
	"github.com/wangzhen94/iam/internal/iamctl/util/templates"
	genericapiserver "github.com/wangzhen94/iam/internal/pkg/server"
	"github.com/wangzhen94/iam/pkg/cli/genericclioptions"
)
...
func NewIAMCtlCommand(in io.Reader, out, err io.Writer) *cobra.Command {
	...
	cmds := &cobra.Command{
		...
		Find more information at:
			https://github.com/wangzhen94/iam/blob/master/docs/guide/en-US/cmd/iamctl/iamctl.md`),
		Run: runHelp,
